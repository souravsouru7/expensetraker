...
def index(request):
    ...
    return render(request,'trakapp/index.html',{'expense_form':expense_form,'expenses':expenses,"total_exp": total_exp,"yearly_sum": yearly_sum,"monthly_sum":monthly_sum,"weekly_sum": weekly_sum})
